<div class="w-[23%] py-6 space-y-10">
    ...
    <div class="flex flex-col gap-8 px-5">
        <div class="-px-4">
            <div class="flex gap-3 items-center hover:bg-[#1D8E48] cursor-pointer bg-[#014F31] px-6 py-3 rounded-full">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                    class="w-8 h-8 stroke-white fill-white">
                    <path
        ...
        <div class="flex justify-between items-center cursor-pointer group">
            <div class="flex gap-3 items-center px-6">
                ...
                <p class="font-bold text-black/70 group-hover:text-[#1D8E48]">Data User</p>
            </div>

            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                class="w-6 h-6 group-hover:stroke-[#1D8E48] group-hover:fill-[#1D8E48] stroke-[#014F31] fill-[#014F31]">
                <path fill-rule="evenodd"
