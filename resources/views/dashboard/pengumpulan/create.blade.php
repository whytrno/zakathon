        ...
        <form action="{{ route('pengumpulan.store') }}" class="space-y-6" method="POST">
            ...
            <div class="grid grid-cols-2 gap-5">
                ...
                <div class="space-y-2">
                    ...
                    <input type="number" value="{{ old('target_zakat') }}" name="target_zakat"
                           class="w-full bg-[#F6F8FA] rounded-[12px] py-2 px-4">
                    @error('target_zakat')
                    <span class="text-red-500 text-sm">{{ $message }}</span>
                    @enderror
                ...
                <div class="space-y-2">
                    ...
                    <input type="number" value="{{ old('target_infak') }}" name="target_infak"
                           class="w-full bg-[#F6F8FA] rounded-[12px] py-2 px-4">
                    @error('target_infak')
                    <span class="text-red-500 text-sm">{{ $message }}</span>
                    @enderror
                ...
                <div class="space-y-2">
                    ...
                    <input type="number" value="{{ old('target_csr') }}" name="target_csr"
                           class="w-full bg-[#F6F8FA] rounded-[12px] py-2 px-4">
                    @error('target_csr')
                    <span class="text-red-500 text-sm">{{ $message }}</span>
                    @enderror
                ...
                <div class="space-y-2">
                    ...
                    <input type="number" value="{{ old('target_dskl') }}" name="target_dskl"
                           class="w-full bg-[#F6F8FA] rounded-[12px] py-2 px-4">
                    @error('target_dskl')
                    <span class="text-red-500 text-sm">{{ $message }}</span>
                    @enderror
