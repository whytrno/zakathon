                    ...
                    <div class="grid grid-cols-2 gap-5">
                        <div class="space-y-4">
                            <div class="space-y-2">
                                ...
                                <select name="jenis" class="w-full bg-[#F6F8FA] rounded-[12px] py-2 px-4" required>
                        ...
                        <div class="space-y-4">
                            <div class="space-y-2">
                                <p>Nama <label class="text-red-700">*</label></p>
                            ...
                            <div class="space-y-2">
                                ...
                                <select name="jenis_kelamin" class="w-full bg-[#F6F8FA] rounded-[12px] py-2 px-4" required>
            ...
            <tbody class="bg-white">
                @foreach ($datas as $data)
                    <tr class="whitespace-nowrap">
                        ...
                        <td onclick="toggleModal('detail', {{ $data->id }})"
                    ...
                    <div id="detailModal{{ $data->id }}"
                        ...
                        <div class="w-2/5 bg-white shadow-xl rounded-[12px] p-7 space-y-5 border border-gray-300">
                            <div class="border-b-2 border-gray-800 flex justify-between pb-2">
                                ...
                                <svg onclick="toggleModal('detail', {{ $data->id }})"
                    ...
                    <div id="editModal{{ $data->id }}"
                        ...
                        <div class="w-2/5 bg-white shadow-xl rounded-[12px] p-7 space-y-5 border border-gray-300">
                            <div class="border-b-2 border-gray-800 flex justify-between pb-2">
                                <h2 class="text-xl font-semibold">Edit Data Muzakki</h2>
                                <svg onclick="toggleModal('edit', {{ $data->id }})"
                                    xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor"
                                    class="w-6 h-6 stroke-red-700 cursor-pointer">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12" />
                            ...
                            <form action="{{ route('muzakki.update', $data->id) }}" method="POST" class="space-y-6">
                                @csrf
                                <div class="grid grid-cols-2 gap-5">
                                    <div class="space-y-4">
                                        <div class="space-y-2">
                                            <p>Jenis Muzakki <label class="text-red-700">*</label></p>
                                            <select name="jenis" class="w-full bg-[#F6F8FA] rounded-[12px] py-2 px-4"
                                                required>
                                                <option value="{{ $data->jenis }}">{{ ucwords($data->jenis) }}</option>
                                                <option disabled>==========================</option>
                                                <option value="perorangan">Perorangan</option>
                                                <option value="lembaga upz">Lembaga UPZ</option>
                                                <option value="lembaga non upz">Lembaga non UPZ</option>
                                            </select>
                                            @error('jenis')
                                                <span class="text-red-500 text-sm">{{ $message }}</span>
                                            @enderror
                                        ...
                                        <div class="space-y-2">
                                            <p>NIK <label class="text-red-700">*</label></p>
                                            <input type="number" name="nik" value="{{ $data->user->nik }}"
                                                class="w-full bg-[#F6F8FA] rounded-[12px] py-2 px-4" required>
                                            @error('nik')
                                                <span class="text-red-500 text-sm">{{ $message }}</span>
                                            @enderror
                                        ...
                                        <div class="space-y-2">
                                            <p>Password</p>
                                            <input type="password" class="w-full bg-[#F6F8FA] rounded-[12px] py-2 px-4">
                                            @error('password')
                                                <span class="text-red-500 text-sm">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="space-y-4">
                                        ...
                                        <div class="space-y-2">
                                            ...
                                            <select name="jenis_kelamin"
                                                class="w-full bg-[#F6F8FA] rounded-[12px] py-2 px-4" required>
                                                <option value="{{ $data->user->jenis_kelamin }}">
                                ...
                                <div class="flex justify-end gap-3">
                                    <button class="bg-[#014F31] py-2 px-4 rounded-[12px] text-white">Ubah</button>
                                    <button onclick="toggleModal('edit', {{ $data->id }})" type="button"
                                        class="border border-gray-800 py-2 px-4 rounded-[12px] text-gray-800">Batal</button>
                                </div>
                            </form>
                        </div>
